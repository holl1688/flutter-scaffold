...
class AddWithdrawAccountPage extends StatelessWidget {
  final logic = Get.put(AddWithdrawAccountLogic()); // 逻辑层
  final state = Get.find<AddWithdrawAccountLogic>().state; // 状态(定义所需数据)
  AddWithdrawAccountPage({Key? key}) : super(key: key);
          ...
          children: [
            ...
            Expanded(
              child: Obx(() => Stepper(
                ...
                steps: ['身份证信息认证', '设置交易密码', '绑定银行卡'].asMap().entries.map(
                  (e) => Step(
                ...
                controlsBuilder: (BuildContext context, ControlsDetails details){
                  return Row(
                    mainAxisAlignment: state.currentStep.value != 0
